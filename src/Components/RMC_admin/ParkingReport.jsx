                        ...
                        <div className="flex flex-1 flex-col">
                          ...
                          {selectedOption === "areaId" && (
                            <div className="flex flex-row">
                              ...
                              <button
                                type="submit"
                                className="flex p-4 ml-2 mr-2 mb-4 mt-4 shadow-md rounded-md bg-[#665DD9] text-white font-bold flex-1 justify-center items-center"
                              >
                                <svg
                                  className="ml-2 mr-2"
                                  fill="white "
                  ...
                  <div className="flex flex-1 justify-center items-center w-full h-full">
                    <div className="flex text-center grid-cols-2 gap-3 justify-center">
                      ...
                      <div>
                        ...
                        <p className="w-40">
                          Total Amount of Vehicle Collection
                        </p>
                      </div>
                    </div>
                  </div>
