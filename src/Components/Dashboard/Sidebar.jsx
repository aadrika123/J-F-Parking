        ...
        <div className="flex flex-1 flex-col justify-start items-center">
          ...
          {userType !== 'Accountant' && (<>
            <div className="flex flex-col w-[95%] m-10 justify-start items-start overflow-auto">
              ...
              <div
                className={`flex h-[50px] justify-center items-center rounded-md  ${path == "/parkingArea" ? "bg-[#5457D6] text-white" : "bg-white "
                  } hover:text-white hover:bg-[#5457D6] cursor-pointer w-[100%] mt-4 mb-4 `}
              >
              ...
              <div
                className={`flex h-[50px] justify-center items-center rounded-md  ${path == "/parkingincharge"
              ...
              <div
                className={`flex h-[50px] justify-center items-center rounded-md  ${path == "/ParkingScheduling"
                  ? "bg-[#5457D6] text-white"
                  : "bg-white "
                  } hover:text-white hover:bg-[#5457D6] cursor-pointer w-[100%] mt-4 mb-4 `}
              >
              ...
              <div
                className={`flex h-[50px] justify-center items-center rounded-md  ${path == "/parkingReport"
                  ? "bg-[#5457D6] text-white"
                  : "bg-white "
                  } hover:text-white hover:bg-[#5457D6] cursor-pointer w-[100%] mt-4 mb-4 `}
              >
              ...
              {/* <div
                className={`flex h-[50px] justify-center items-center rounded-md  ${path == "/accountant" ? "bg-[#5457D6] text-white" : "bg-white "
                  } hover:text-white hover:bg-[#5457D6] cursor-pointer w-[100%] mt-4 mb-4 `}
              >
                <Link className="flex flex-1" to="/accountant">
                  {" "}
                  <div className="flex w-full justify-between">
                    <div className="flex w-fit">
                      <div className="h-10 w-10 bg-[#5457D6] flex rounded-md justify-center items-center">
